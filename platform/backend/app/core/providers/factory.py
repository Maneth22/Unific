...
from app.agents.whatsapp_community.providers.stub_reply_generator import StubReplyGenerator
...
def get_reply_generator() -> ReplyGenerator:
    if settings.reply_provider == "gemini":
        from app.agents.whatsapp_community.providers.gemini_reply_generator import GeminiReplyGenerator
...
def get_comms_agent():
    ...
    if settings.comms_agent_provider == "gemini":
        from app.agents.whatsapp_community.providers.gemini_comms_agent import GeminiCommsAgent

        return GeminiCommsAgent()
    from app.agents.whatsapp_community.providers.mock_comms_agent import MockCommsAgent
